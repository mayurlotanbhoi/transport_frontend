...
const ImageCarousel = () => {
    const images = [
        { src: 'https://tse3.mm.bing.net/th?id=OIP.qMjWQxQpzaBsPJcKChjPJwHaEK&pid=Api&P=0&h=180', alt: 'ads1', caption: 'Order Now' },
        { src: 'https://tse3.mm.bing.net/th?id=OIP.qMjWQxQpzaBsPJcKChjPJwHaEK&pid=Api&P=0&h=180', alt: 'ads2', caption: 'Book Now' },
        // { src: 'https://tse3.mm.bing.net/th?id=OIP.qMjWQxQpzaBsPJcKChjPJwHaEK&pid=Api&P=0&h=180', alt: 'ads3', caption: 'Shop Now' },
    ];
            ...
            >
                {images.map((image, index) => (
                    <div className='w-full flex justify-center rounded-md  p-2' key={index}>
                        <img className=' w-auto h-24  rounded-md  object-cover' src={image.src} alt={image.alt} />
